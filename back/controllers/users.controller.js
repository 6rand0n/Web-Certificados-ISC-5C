...
const {createSession, deleteSession} = require("../middleware/usersRequired.middleware");
...
exports.login = (req, res) => {
  ...
  return res.status(200).json({
    ...
    usuario: { cuenta: match.cuenta, nombre: match.nombre, paid: match.paid, hasAttempt: match.hasAttempt}, // Devuelve solo la cuenta, NO la contraseña
...
exports.getProfile = (req, res) => {
  ...
  return res.status(200).json({
    usuario: { 
      cuenta: user.cuenta, nombre: user.nombre
    }
  });
};